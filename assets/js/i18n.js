...
const translations = {
  es: {
    ...
    "labs.d1.title": "Heartbeats Memories — Recuerdos y Momentos Inolvidables",
    "labs.d1.sub": "Cuenta Regresiva Emocional y Momentos Compartidos",
    "labs.d1.desc": "Una hermosa aplicación para mantener vivos tus momentos más especiales: aniversarios, metas, viajes o recuerdos inolvidables con fotos familiares y tu música favorita. Diseñada para funcionar suavemente en cualquier computador y en cualquier teléfono inteligente (smartphone), cuidando al 100% tu privacidad sin requerir conexión a internet ni suscripciones mensuales.",
    "labs.d1.platforms": "Fondo de Pantalla · Computador y Teléfono Inteligente · 100% Privado",
    ...
    "labs.d1.price_hook": "💡 <em>A diferencia de otras apps, no hay arriendo mensual ni avisos publicitarios, ¡y transferible de equipo!</em>",
    "labs.d1.price_usd": "(Aprox. 5 USD)",
    "labs.d1.coupon_toggle": "¿Tienes un cupón de descuento?",
    "labs.d1.coupon_placeholder": "Ingresa tu código",
    "labs.d1.coupon_apply": "Aplicar",
    "labs.d1.coupon_remove": "Quitar",
    "labs.d1.coupon_applied": "🎉 ¡Cupón aplicado! 50% de descuento (-$2.500 CLP)",
    "labs.d1.coupon_empty": "Por favor ingresa un código promocional.",
    "labs.d1.coupon_validating": "Validando código con el servidor...",
    "labs.d1.coupon_net_error": "No se pudo conectar con el servidor para validar el cupón.",
    "labs.d1.coupon_invalid": "Cupón no válido o inexistente.",
    "labs.d1.coupon_expired": "Este código promocional ha expirado.",
    "labs.d1.btn_buy": "Pagar con",
    "labs.d1.btn_buy_alt": "Pagar con",
    "labs.d1.btn_pay_with": "Pagar con",
    "labs.d1.qr_heading": "Paga con QR",
    "labs.d1.qr_subtext": "Desde tu celular o app bancaria favorita o a través del siguiente botón de pago.",
    "labs.d1.link_alt": "O pagar en este navegador",
    "labs.d1.btn_catalog": "Ver Catálogo de Funcionalidades y Precios",
    ...
    "labs.d1.btn_demo": "Probar Simulador Interactivo",
    ...
    "catalog.hero_hook": "💡 <strong>A diferencia de otras apps, no hay arriendo mensual ni avisos publicitarios.</strong> Compras tu licencia una sola vez para 1 equipo personal y es tuya para siempre con todas las mejoras y actualizaciones continuas, ¡transferible a nuevo equipo!",
    ...
    "catalog.f11.title": "Continuidad de por vida y cambio de equipo",
    "catalog.f11.desc": "Tu compra es para siempre. Si adquieres un nuevo teléfono inteligente o computador, sufres pérdida de tu equipo o deseas cambiar de dispositivo, cuentas con autogestión para transferir tu licencia con 1 solo clic ingresando tu correo de compra.",
    "catalog.footer_btn_buy": "Pagar con",
  ...
  en: {
    ...
    "labs.d1.title": "Heartbeats Memories — Cherished Milestones",
    "labs.d1.sub": "Live Countdown & Shared Emotional Milestones",
    "labs.d1.desc": "A warm and beautiful app to keep your most treasured milestones alive: anniversaries, life goals, travels, and unforgettable memories with personal photos and favorite songs. Works smoothly on any computer and smartphone, 100% private, with no monthly subscriptions or cloud dependencies.",
    "labs.d1.platforms": "Desktop Wallpaper · Smartphone / Computer · 100% Private",
    ...
    "labs.d1.price_hook": "💡 <em>Unlike other apps, no monthly fees or ads, and easily transferable to a new device!</em>",
    "labs.d1.price_usd": "(Approx. $5 USD)",
    "labs.d1.coupon_toggle": "Have a discount coupon?",
    "labs.d1.coupon_placeholder": "Enter promo code",
    "labs.d1.coupon_apply": "Apply",
    "labs.d1.coupon_remove": "Remove",
    "labs.d1.coupon_applied": "🎉 Coupon applied! 50% discount (-$2,500 CLP / ~$2.5 USD)",
    "labs.d1.coupon_empty": "Please enter a promo code.",
    "labs.d1.coupon_validating": "Validating code with server...",
    "labs.d1.coupon_net_error": "Could not connect to server to validate coupon.",
    "labs.d1.coupon_invalid": "Invalid promo code.",
    "labs.d1.coupon_expired": "This promo code has expired.",
    "labs.d1.btn_buy": "Pay with",
    "labs.d1.btn_buy_alt": "Pay with",
    "labs.d1.btn_pay_with": "Pay with",
    "labs.d1.qr_heading": "Pay with QR",
    "labs.d1.qr_subtext": "From your mobile banking app or digital wallet, or using the payment button below.",
    "labs.d1.link_alt": "Or pay directly in this browser",
    "labs.d1.btn_catalog": "View Features & Pricing Catalog",
    ...
    "catalog.hero_hook": "💡 <strong>Unlike other apps, no monthly fees or ads.</strong> You purchase your license once for 1 personal device and it is yours forever with continuous updates included, plus transferable to a new device!",
    ...
    "catalog.f2.title": "Up to 10 thematic gemstone colors",
    ...
    "catalog.f11.title": "Lifetime continuity & device transfer",
    "catalog.f11.desc": "Your purchase is forever. If you get a new smartphone or computer, replace a lost device, or switch platforms, you can transfer your license with 1 click using your purchase email.",
    "catalog.footer_btn_buy": "Pay with",
